...
pimcore.registerNS('coreshop.paymentproviderrule.conditions.postcodes');

coreshop.paymentproviderrule.conditions.postcodes = Class.create(coreshop.rules.conditions.abstract, {
    type: 'postcodes',
