...
pimcore.registerNS('coreshop.paymentproviderrule.conditions.dimension');

coreshop.paymentproviderrule.conditions.dimension = Class.create(coreshop.rules.conditions.abstract, {
    type: 'dimension',
