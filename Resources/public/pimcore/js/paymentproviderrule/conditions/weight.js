...
pimcore.registerNS('coreshop.paymentproviderrule.conditions.weight');

coreshop.paymentproviderrule.conditions.weight = Class.create(coreshop.rules.conditions.abstract, {
    type: 'weight',
